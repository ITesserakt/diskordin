...
suspend fun Implementation.sendPayload(data: GatewayCommand, sequenceId: Int?) = withContext(Dispatchers.IO) {
    val logger = KotlinLogging.logger("[WebSocket transactions]")
